...
def run_training(out_name, params_dict_updates):
    ...
    params = {
        ...
        'learning_rate': 0.00055221, # fastest convergence for 1 missing sc
        'warmup_iters': 422,
...
if __name__ == "__main__":
    ...
    n_layers = 6
    use_residual_list = [[j for j in range(n_layers) if j not in [i]] for i in range(n_layers)]
    pe_type_list = ['nope'] * len(use_residual_list)
