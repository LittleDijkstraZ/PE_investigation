...
use_pe = 'original' # default to original
use_residual = True # default to use all residual connections
layerwise_pe = False # default to not use layerwise positional encodings
causal_training = True # train it the default causal way
