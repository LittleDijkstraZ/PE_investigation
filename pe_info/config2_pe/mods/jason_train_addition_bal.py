...
out_dir = f'outputs/mods{pe_status}{residual_status}'
...
wandb_project = 'mods'
wandb_run_name = f'mods{pe_status}{residual_status}'
...
train_data_path = 'train_mods_500.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/mods/test_mods_500.txt"
...
# non_causal_fix_length = 14 # for 5-digit mods
