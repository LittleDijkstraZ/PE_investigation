...
out_dir = f'outputs/order{pe_status}{residual_status}'
...
wandb_project = 'order'
wandb_run_name = f'order{pe_status}{residual_status}'
...
block_size = 256 # context of up to 256 porderious characters
train_data_path = 'train_order_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/order/test_order_10000.txt"
...
# non_causal_fix_length = 14 # for 5-digit order
