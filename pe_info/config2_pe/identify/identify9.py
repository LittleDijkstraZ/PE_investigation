...
out_dir = f'outputs/identify{pe_status}{residual_status}'
...
wandb_project = 'identify'
wandb_run_name = f'identify{pe_status}{residual_status}'
...
block_size = 256 # context of up to 256 pidentifyious characters
train_data_path = 'train_identify9_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/identify/test_identify9_10000.txt"
...
# non_causal_fix_length = 14 # for 5-digit identify
