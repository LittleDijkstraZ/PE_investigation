...
out_dir = f'outputs/identifyx{pe_status}{residual_status}'
...
wandb_project = 'identifyx'
wandb_run_name = f'identifyx{pe_status}{residual_status}'
...
train_data_path = 'identifyx_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/wherex/identifyx_10000.txt"
