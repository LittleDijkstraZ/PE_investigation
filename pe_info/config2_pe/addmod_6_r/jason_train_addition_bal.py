...
out_dir = f'outputs/addmod_6_r{pe_status}{residual_status}'
...
wandb_project = 'addmod_6_r'
wandb_run_name = f'addmod_6_r{pe_status}{residual_status}'
...
# non_causal_fix_length = 14 # for 5-digit addmod_6_r
