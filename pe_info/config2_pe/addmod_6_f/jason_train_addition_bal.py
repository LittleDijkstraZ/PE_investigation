...
out_dir = f'outputs/addmod_6_f{pe_status}{residual_status}'
...
wandb_project = 'addmod_6_f'
wandb_run_name = f'addmod_6_f{pe_status}{residual_status}'
...
train_data_path = 'train_addmod_6_f_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/addmod_6_f/test_addmod_6_f_10000.txt"
...
# non_causal_fix_length = 14 # for 5-digit addmod_6_f
