...
out_dir = f'outputs/rev16{pe_status}{residual_status}'
...
wandb_project = 'rev16'
wandb_run_name = f'rev16{pe_status}{residual_status}'
...
train_data_path = 'train_rev16_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/rev/test_rev16_10000.txt"
...
# non_causal_fix_length = 14 # for 5-digit rev
