...
out_dir = f'outputs/rev{pe_status}{residual_status}'
...
wandb_project = 'rev'
wandb_run_name = f'rev{pe_status}{residual_status}'
...
train_data_path = 'train_rev_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/rev/test_rev_10000.txt"
