...
out_dir = f'outputs/modp{pe_status}{residual_status}'
...
wandb_project = 'modp'
wandb_run_name = f'modp{pe_status}{residual_status}'
...
train_data_path = 'train_modp_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/modp/test_modp_10000.txt"
...
# non_causal_fix_length = 14 # for 5-digit modp
