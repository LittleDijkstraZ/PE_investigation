...
out_dir = f'outputs/wherex7{pe_status}{residual_status}'
...
wandb_project = 'wherex7'
wandb_run_name = f'wherex7{pe_status}{residual_status}'
...
train_data_path = 'train_wherex7_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/wherex/test_wherex7_10000.txt"
