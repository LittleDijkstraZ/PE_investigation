...
out_dir = f'outputs/oddc{pe_status}{residual_status}'
...
wandb_project = 'oddc'
wandb_run_name = f'oddc{pe_status}{residual_status}'
...
train_data_path = 'train_oddc_10000.txt'
# val_data_path = 'val.bin'
ckpt_path_name = 'ckpt_10000.pt'
eval_addition = True
start = "FILE:data/oddc/test_oddc_10000.txt"
